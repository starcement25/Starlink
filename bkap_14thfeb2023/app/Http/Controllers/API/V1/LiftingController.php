...
class LiftingController extends Controller
{
    ...
    function liftingHistoryCoreSelect($query){
        $query->select('L.id as lifting_id','U2.name as mason_name','U2.phone as mason_phone','U2.aadhaar_no as mason_aadhaar_no','U2.id as mason_id', 'U.id as dealer_id', 'U.name as dealer_name','P.id as product_id','P.name as product_name','L.qty','L.lifting_date','L.remark','R.point as point','R.is_verified as is_verified','U.name as mason_category');
        return $query;
    } 
