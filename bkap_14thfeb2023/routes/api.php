...
Route::group(['namespace' => 'App\Http\Controllers\API'],function(){
    ...
    Route::group(['prefix' => 'v1','namespace' =>'V1'],function(){
        ...
        Route::post('/get-rewards', ['uses' => 'RewardController@getRewards'])->middleware(['auth:api']);
        ...
        Route::get('/get-gift-catalog', ['uses' => 'UserController@getGiftLink'])->middleware(['auth:api']);
        Route::get('/get-social-link', ['uses' => 'UserController@getSocialLink'])->middleware(['auth:api']);    
        Route::get('/get-notification', ['uses' => 'UserController@getNotification'])->middleware(['auth:api']);
        Route::post('/get-redeemtion', ['uses' => 'UserController@getRedeemtion'])->middleware(['auth:api']);
        Route::post('/apply-redeemtion', ['uses' => 'UserController@applyRedeemtion'])->middleware(['auth:api']);    
        Route::post('/get-rewards-by-mason', ['uses' => 'RewardController@getRewardsByMason'])->middleware(['auth:api']);    
        Route::post('/get-redeemtion-by-mason', ['uses' => 'UserController@getRedeemtionByMason'])->middleware(['auth:api']);
         Route::get('/get-all-dealers', ['uses' => 'MasonController@getAllDealers']);
        // for TE
