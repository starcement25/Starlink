    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                {!! Form::open(['route'=> 'dealers.upload.save', 'method'=> 'POST' ,'id'=> 'uploadForm', 'files' => true]) !!}
                <div class="card-body">
                    <div id="message">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ asset('format/dealer-format.csv') }}" download="dealer-format">Download Format</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
...
@push('dealer-bulk-upload-blade')
    <script>
      ...
      //  $('#process').css('display', 'block');
            ...
            $.ajax({
                url: "{{ route('dealers.upload.progress') }}",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                type: "POST",
