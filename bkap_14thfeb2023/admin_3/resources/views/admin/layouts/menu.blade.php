...
<li class="nav-item menu-is-opening {{ Request::is('*products', '*branch', '*users', '*catalogues', '*mason-categories') ? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ Request::is('*products', '*branch', '*users', '*catalogues', '*mason-categories') ? 'active' : '' }}">
