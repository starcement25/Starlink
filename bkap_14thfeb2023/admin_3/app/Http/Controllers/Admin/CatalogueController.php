...
class CatalogueController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.catalogue.create')->with('categoryOption', $masonCategory)->with('categorySelected', "");
    ...
    public function edit($id)
    {
        ...
        return view('admin.catalogue.edit')->with('catalogue', $catalogue)
                ->with('categoryOption', $masonCategory)->with('categorySelected', $catalogue->mason_category_id);
    }
