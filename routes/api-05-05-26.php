...
Route::group(['namespace' => 'App\Http\Controllers\API'],function(){
 ...
 //////////BIRTHDAY////////////////
    Route::get('/v1/get-birthday/{id}', ['uses' => 'BdayController@getBday']);
    Route::post('/v1/store-birthday', ['uses'=>'BdayController@storeBday']);
    Route::post('/v1/check-and-log-birthday', 'BdayController@checkAndLogBirthday');
    //////////////////////////////
    //Version: V1
    Route::group(['prefix' => 'v1','namespace' =>'V1'],function(){
        ...
        //  Route::post('/apply-force-redeemtion', ['uses' => 'UserController@applyForceRedeemtion'])->middleware(['auth:api', 'account_status']); 
       ...
       Route::post('/get-support', ['uses' => 'RewardController@getSupport'])->middleware(['auth:api', 'account_status']);
        Route::get('/view-banner','UserController@viewBanner')->middleware(['auth:api', 'account_status']);
        ...
        // Settings
        Route::get('/delete_account_btn', ['uses' => 'SettingsController@delete_account_btn']);
