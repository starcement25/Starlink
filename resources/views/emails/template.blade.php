                ...
                <tr>
                    <td style="padding:24px; font-size:15px; color:#374151; line-height:1.6;">
                        ...
                        <p style="margin:0 0 20px;">
                            <b>{{$user}}</b> has submitted feedback for the following product. Details are provided below.
                        </p>
                        ...
                        <table width="100%" cellpadding="8" cellspacing="0" 
                            ...
                            <tr>
                                <td style="border:1px solid #ddd; font-weight:bold;">Feedback Message</td>
                                <td style="border:1px solid #ddd;"> {{ $feedback }}</td>
                            </tr>
                        ...
                        <p style="margin-top:25px;">
                            Thank you.<br>
                            <strong>StarLink Feedback System</strong>
                        </p>
