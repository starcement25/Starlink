...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('allocated_branches[]', $branchOption, $branchSelected, ['class' => ($errors->has('allocated_branches')) ? 'form-control border-danger' : 'form-control','multiple'=>true]) !!}
    
    @error('allocated_branches')
     <span class="text text-danger">{{ $message }}</span>
    @enderror
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('marital_status', $maritialStatusOption, $maritialStatus, ['class' => ($errors->has('marital_status')) ? 'form-control border-danger' : 'form-control']) !!}
