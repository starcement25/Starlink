        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if(session()->has('redeemtion_import'))
                        <div class="mb-2">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ asset('format/redeemtion-format.csv') }}" download="redeemtion-format">Download Format</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
        ...
        $(document).ready(function(){
          //  getProgress();
            $('#uploadForm').on('submit', function(e){
                ...
                $.ajax({
                    url: "{{ route('redeemtion.upload.save') }}",
                    headers: {
