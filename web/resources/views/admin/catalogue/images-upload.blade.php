...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Upload Catalogues Images') }}</div>
               {{--  <span class="badge badge-success">
                    22
                </span> --}}
                {!! Form::open(['route'=> 'catalogue.images.upload', 'method'=> 'POST' ,'id'=> 'uploadForm', 'files' => true]) !!}
                <div class="card-body">
                    <div id="message">
                        ...
                        <div class="mb-3" id="uploadField">
                            ...
                            {!! Form::label('images', 'Upload Images (20 Files)', ['class' => 'form-label']) !!}
