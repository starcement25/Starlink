...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Bulk Update Of Catalogues Status & Point') }}</div>
                {!! Form::open(['route'=> 'catalogue.bulk-update.status.show', 'method'=> 'POST' ,'id'=> 'uploadForm', 'files' => true]) !!}
                <div class="card-body">
                    <div id="message">

                    </div>
                    @if(session()->has('catalogue_status_import'))
                        <div class="mb-2">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('catalogue.format.download') }}" download="catalogue-format">Download Format</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
        ...
        $(document).ready(function(){
          //  getProgress();
            $('#uploadForm').on('submit', function(e){
                ...
                $.ajax({
                    url: "{{ route('catalogue.bulk-update.status.show') }}",
                    headers: {
