...
<!-- Catalogue Type Field -->
<div class="form-group col-sm-6">
    {!! Form::label('catalogue_type_id', 'Catalogue Type:') !!}
    {!! Form::select('catalogue_type_id', $catalogueTypes, $catalogueTypeSelected, ['class' => ($errors->has('catalogue_type_id')) ? 'form-control border-danger' : 'form-control']) !!}
    @error('catalogue_type_id')
        <span class="text text-danger">{{ $message }}</span>
    @enderror
</div>
