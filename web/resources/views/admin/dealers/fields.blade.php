...
<!-- Name Field -->
<div class="form-group col-sm-6">
    {!! Form::label('emp_code', 'Customer Code:') !!}
...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('linked_dealer', $dealerOption, $dealerSelected, ['id' => 'linked_dealer','class' => ($errors->has('linked_dealer')) ? 'form-control border-danger' : 'form-control select2bs4']) !!}
    @error('linked_dealer')
        <span class="text text-danger">{{ $message }}</span>
    @enderror
</div>
