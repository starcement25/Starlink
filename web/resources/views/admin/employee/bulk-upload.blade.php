...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Upload Employee') }}</div>
                {!! Form::open(['route'=> 'employee.upload.save', 'method'=> 'POST' ,'id'=> 'uploadForm', 'files' => true]) !!}
                <div class="card-body">
                    <div id="message">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ asset('format/employee-format.csv') }}" download="employee-format">Download Format</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
        ...
        $(document).ready(function(){
          //  getProgress();
            $('#uploadForm').on('submit', function(e){
                ...
                $.ajax({
                    url: "{{ route('employee.upload.save') }}",
                    headers: {
