...
@section('content') 
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            <form action="{{route('dealer.save.pending.liftings.edit', ['id' => encrypt($lifting->id)])}}" method="post" id="filterForm">
                    @csrf
                    <div class="row pb-4">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="number" name="qty" class="form-control" value= "{{$lifting->qty}}">
                        </div>
                        <div class="form-group col-md-2">
                            <label for="">&nbsp; </label>
