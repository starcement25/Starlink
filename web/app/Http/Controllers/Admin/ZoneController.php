...
class ZoneController extends Controller
{
    ...
    {
        \Helper::checkIsUserAuthorizeToPerformTheTask('zones.view') ;
    ...
    {
        \Helper::checkIsUserAuthorizeToPerformTheTask('zones.create') ;
    ...
    {
        \Helper::checkIsUserAuthorizeToPerformTheTask('zones.edit') ;
        $Zone = Zone::find($id);
    ...
    {
        \Helper::checkIsUserAuthorizeToPerformTheTask('zones.delete') ;
        $zone = Zone::find($id);
        if (empty($zone)) {
            Flash::error('Zone not found');
            return redirect(route('zones.index'));
