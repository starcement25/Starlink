...
import { SafeAreaView, ScrollView, Text, TextInput, View, Image, TouchableOpacity, Platform, Modal, TouchableWithoutFeedback, FlatList } from 'react-native'
        ...
        if (valueDealerRssd == null) {
            ...
            if (parseInt(max) > 0) {
                if (parseInt(qty) >= parseInt(min) && parseInt(qty) <= parseInt(max)) {
                    if (parseInt(qty) <= parseInt(liftingLimit)) {
            ...
            <View style={{ width: '100%', height: '100%', position: 'absolute', flexDirection: 'column' }}>
                <View style={{ width: '100%', height: 70 }}>
                    <View style={{ width: '100%', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
                        <Text style={{
                            ...
                            fontWeight: '600',
                            marginBottom: 20
                        }}>{convertForShowData(textValue.ADD_LIFTING)}</Text>
                    </View>
                ...
                <View style={{ width: '100%', flex: 1, paddingHorizontal: 30 }}>
                    <View style={{ width: '100%', height: '100%', backgroundColor: '#FFF', borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingVertical: 15, paddingHorizontal: 10 }}>
                        ...
                        <View style={{ height: 10 }} />
                        <>
                            <View style={{ width: '100%', height: 50, paddingHorizontal: 10, backgroundColor: '#FFF5F6', borderRadius: 8, borderWidth: 1, borderColor: '#FFDBDD' }}>
                                <TextInput
